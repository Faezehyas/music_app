...
class VerticalSongItem extends StatefulWidget {
  MusicModel musicModel = new MusicModel();
  bool? isFavorite;
  bool isDownload = false;
  int playListId = 0;
  VerticalSongItem(
      this.musicModel, this.isFavorite, this.isDownload, this.playListId);

  @override
  _VerticalSongItemState createState() => _VerticalSongItemState();
}

class _VerticalSongItemState extends State<VerticalSongItem> {
  List<PopupMenuEntry<int>> menus = [];
  bool deletedFromPlayList = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Visibility(
      visible: (widget.musicModel.is_favorited ?? false) ||
          !(widget.isFavorite ?? false) &&
              (!deletedFromPlayList || widget.playListId == 0),
          ...
          menus = [
            ...
            PopupMenuItem<int>(
                ...
                onTap: () {
                  ...
                  dataBaseProvider.deleteDownloaded(widget.musicModel.id!);
                  mainProvider.deleteDownloaded(widget.musicModel.id!);
                },
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                                    ...
                                    onSelected: (index) {
                                      if (index == 1 &&
                                        ...
                                        Navigator.push(
                                          ...
                                          widget.playListId > 0)) {
                                        mainProvider.deleteMusicFromPlayList(
                                            context,
                                            widget.musicModel.id!,
                                            widget.playListId);
                                        mainProvider
                                            .changeUserPlayListMusicCount(
                                                widget.playListId);
                                        setState(() {
                                          deletedFromPlayList =
                                              !deletedFromPlayList;
