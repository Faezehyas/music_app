...
class WithoutTabPlayListScreen extends StatefulWidget {
  String title = '';
  String iconUrl = '';

  WithoutTabPlayListScreen(this.title, this.iconUrl);

  @override
  _WithoutTabPlayListScreenState createState() =>
      _WithoutTabPlayListScreenState();
}

class _WithoutTabPlayListScreenState extends State<WithoutTabPlayListScreen> {
