...
class UserListScreenWithList extends StatefulWidget {
  String title = '';
  List<UserModel> userList = [];

  UserListScreenWithList(this.title, this.userList);

  @override
  _UserListScreenWithListState createState() => _UserListScreenWithListState();
}

class _UserListScreenWithListState extends State<UserListScreenWithList> {
            ...
            Expanded(
              child: mainProvider.hasInternet
                  ? ListView(
                    ...
                    splashColor: Colors.transparent.withOpacity(0),
                              onTap: () {
                                if ((UserInfos.getString(context, 'username') ??
                                        '') ==
                                    e.username) {
                                  context.read<AuthProvider>().avatar =
                                      e.avatar;
