...
class PlayListScreen extends StatefulWidget {
  ...
  PlayListScreen(this.title, this.iconUrl);
...
class _PlayListScreenState extends State<PlayListScreen>
          ...
          children: [
            ...
            Expanded(
              ...
              Container(
                  ...
                  child: PagedListView<int, PlayListModel>(
                              ...
                              onTap: () {
                                Navigator.push(
                                    ...
                                    SwipeablePageRoute(
                                        ...
                                        builder: (context) =>
                                            PlayListDetailScreen(item, false)));
                              },
                              child: VerticalPlayListItem(item, false),
                            ),
              ...
              Container(
                color: MyTheme.instance.colors.secondColorPrimary,
                child: ListView(
                  children: mainProvider.playListList
                      .map((e) => InkWell(
                    highlightColor: Colors.transparent.withOpacity(0),
                    splashColor: Colors.transparent.withOpacity(0),
                          onTap: () {
  ...
  Future<void> pageFetch(int offset) async {
    try {
      final newItems =
          await _mainProvider.getLatestPlayListWithPaging(context, offset, 20);
